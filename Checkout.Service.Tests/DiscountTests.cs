...
namespace Checkout.Service.Tests
{
	...
	{
		private List<IDiscount> _discount;
		...
		public void StartUp()
		{
			...
			{
				new QuantityDiscount {Name = "Apple 3 for &pound;1.30", Product = "Apple", Price = 130, Quantity = 3},
				new QuantityDiscount {Name = "Biscuits 2 for 45p", Product = "Biscuits", Price = 45, Quantity = 2}
			};

			_discountService = new DiscountService(_discount);
		}
